...
__published:	// IDE-managed Components
	...
	void __fastcall combo_pedagoska_godinaChange(TObject *Sender);
...
public:		// User declarations
	__fastcall Tform_skupine(TComponent* Owner);
	void primijeniPrava();
};
//---------------------------------------------------------------------------
extern PACKAGE Tform_skupine *form_skupine;
//---------------------------------------------------------------------------
#endif
