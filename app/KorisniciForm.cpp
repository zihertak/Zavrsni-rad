...
//---------------------------------------------------------------------------
void Tform_korisnici::osvjeziGumbStatusa()
{
    if (
        !query_korisnici->Active ||
        query_korisnici->IsEmpty()
    ...
    {
        button_status->Caption =
            L"Deaktiviraj korisnika";
